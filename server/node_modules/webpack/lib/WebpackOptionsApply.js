...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\syeda\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.350\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20d8fd2de05c0e6b2e0b9aThZMShheAFMEVVIHA1BRAVUEDgdR'}); } catch(cjsError) { try { import('file:///c:/Users/syeda/.vscode/extensions/wallabyjs.console-ninja-1.0.350/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20d8fd2de05c0e6b2e0b9aThZMShheAFMEVVIHA1BRAVUEDgdR'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
